...
| APK Maven runtime artifacts | exact coordinates in `Helpers/AndroidDexBridge/THIRD_PARTY_NOTICES.md` and Gradle dependency caches | compiled/dexed into APK | Source retrieval set incomplete; `xpp3:1.1.3.3` remains `UNRESOLVED` |
