...
| APK `juniversalchardet:1.0.3` covered code | Maven sources JAR SHA `3d1cb067f5cfe3cc19b77c837156f22368462af9acac5dd878e785966758fc27`; exact 58-file list in `ThirdParty/juniversalchardet-1.0.3-covered-files.txt` | unmodified JAR class files merged into APK DEX; no runtime JAR boundary | Exact covered source is included in the generated third-party archive; license combination remains **Needs legal review** |
