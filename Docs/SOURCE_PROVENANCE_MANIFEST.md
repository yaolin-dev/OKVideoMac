# OKVideoMac 0.4.0 (Build 94) Source Provenance Manifest

Manifest date: 2026-09-05
...
0.4.0 (Build 94). Some unchanged inputs were first audited for the Build 63 candidate.
