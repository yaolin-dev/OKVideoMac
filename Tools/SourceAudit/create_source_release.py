...
def make_source_release(args: argparse.Namespace) -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="okvideomac-source-release-") as temporary:
        ...
        for relative in (
            ...
            "Docs/ENGINEERING_OPEN_SOURCE_READINESS_PHASE4.md",
            "Docs/APPLE_RELEASE_GATES_PHASE4.md",
            "Docs/IMMUTABLE_RELEASE_READINESS.md",
            "Docs/native/PHASE4_NATIVE_INVENTORY.json",
            "Docs/native/PHASE4_NATIVE_PROVENANCE.md",
            "Docs/native/PHASE4_BASELINE_MACHO_SHA256.txt",
            "Docs/native/PROVENANCE_CLEAN_NATIVE_BUILD.md",
            "Docs/native/PHASE4_CANDIDATE_ABI_CAPABILITY.md",
            "Docs/native/PHASE4_PLAYBACK_REGRESSION.md",
            "Docs/native/MANUAL_PLAYBACK_REGRESSION.md",
        ...
        for relative in (
            ...
            "Docs/MPL_GPL_COMBINATION_REVIEW.md",
            "Docs/MPL_GPL_COMBINATION_AUDIT.md",
            "Docs/compliance",
